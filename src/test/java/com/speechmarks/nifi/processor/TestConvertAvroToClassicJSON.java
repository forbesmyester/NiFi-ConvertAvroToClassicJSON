...
public class TestConvertAvroToClassicJSON {

    @Test
    public void testSingleAvroMessage() throws IOException {
        final TestRunner runner = TestRunners.newTestRunner(new ConvertAvroToClassicJSON());
        ...
        runner.assertAllFlowFilesTransferred(ConvertAvroToClassicJSON.REL_SUCCESS, 1);
        final MockFlowFile out = runner.getFlowFilesForRelationship(ConvertAvroToClassicJSON.REL_SUCCESS).get(0);
    ...
    public void testSingleAvroMessage_noContainer() throws IOException {
        final TestRunner runner = TestRunners.newTestRunner(new ConvertAvroToClassicJSON());
        runner.setProperty(ConvertAvroToClassicJSON.CONTAINER_OPTIONS, ConvertAvroToClassicJSON.CONTAINER_NONE);
        final Schema schema = new Schema.Parser().parse(new File("src/test/resources/user.avsc"));
    ...
    public void testSingleSchemalessAvroMessage() throws IOException {
        ...
        runner.setProperty(ConvertAvroToClassicJSON.SCHEMA, stringSchema);
    ...
    public void testMultipleAvroMessages() throws IOException {
        ...
        runner.setProperty(ConvertAvroToClassicJSON.CONTAINER_OPTIONS, ConvertAvroToClassicJSON.CONTAINER_ARRAY);
    ...
    public void testNonJsonHandledProperly() throws IOException {
        ...
        runner.run();
        runner.assertAllFlowFilesTransferred(ConvertAvroToClassicJSON.REL_FAILURE, 1);
    }
    ...
    @Test
    public void testZeroRecords_noContainer() throws IOException {
        final TestRunner runner = TestRunners.newTestRunner(new ConvertAvroToClassicJSON());
        final Schema schema = new Schema.Parser().parse(new File("src/test/resources/user.avsc"));
        runner.setProperty(ConvertAvroToClassicJSON.CONTAINER_OPTIONS, ConvertAvroToClassicJSON.CONTAINER_NONE);
